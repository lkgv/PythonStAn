...
**Generated:** 2025-10-26T12:03:18.119391
...
- **Modules failed**: 0
- **Success rate**: 100.0%
- **Throughput**: 1021.4 LOC/sec

## Points-to Analysis Metrics

- **Total variables tracked**: 481
- **Non-empty points-to sets**: 481
- **Singleton sets**: 355 (73.8%)
- **Empty sets**: 0
- **Average set size**: 1.63
- **Maximum set size**: 14
- **Median set size**: 1.0
...
- **Total objects created**: 182
- **Average objects per variable**: 1.63
- **Variables with no objects**: 0
- **Variables with singleton**: 355
- **Variables with multiple objects**: 126
...
- **Peak memory**: 31.65 MB
- **Current memory**: 31.30 MB

## Successfully Analyzed Modules

| Module | Duration (s) | Functions | LOC |
|--------|-------------|-----------|-----|
| __init__.py | 0.17 | 1 | 63 |
| __main__.py | 0.15 | 0 | 2 |
| app.py | 1.56 | 78 | 1857 |