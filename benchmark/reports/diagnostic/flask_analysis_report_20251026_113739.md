...
**Generated:** 2025-10-26T11:36:18.368496
...
- **Total objects created**: 443
- **Average objects per variable**: 4.83
- **Variables with no objects**: 0
- **Variables with singleton**: 2399
- **Variables with multiple objects**: 2630
...
- **Peak memory**: 42.09 MB
- **Current memory**: 41.01 MB

## Successfully Analyzed Modules

| Module | Duration (s) | Functions | LOC |
|--------|-------------|-----------|-----|
| __init__.py | 8.05 | 1 | 63 |
| __main__.py | 8.01 | 0 | 2 |
| app.py | 9.07 | 78 | 1857 |
| blueprints.py | 8.20 | 28 | 578 |
| cli.py | 8.18 | 31 | 760 |
| config.py | 8.40 | 12 | 262 |
| ctx.py | 7.80 | 26 | 324 |
| debughelpers.py | 6.78 | 6 | 129 |
| globals.py | 7.65 | 6 | 87 |
| helpers.py | 8.32 | 21 | 532 |