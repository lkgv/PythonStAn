...
**Generated:** 2025-10-26T11:00:07.484536
...
- **Modules failed**: 0
- **Success rate**: 100.0%
- **Throughput**: 977.9 LOC/sec

## Points-to Analysis Metrics

- **Total variables tracked**: 573
- **Non-empty points-to sets**: 573
- **Singleton sets**: 484 (84.5%)
- **Empty sets**: 0
- **Average set size**: 1.26
- **Maximum set size**: 13
- **Median set size**: 1.0
...
- **Total classes**: 160
- **Classes with MRO**: 160
- **Maximum MRO length**: 3
- **Average MRO length**: 2.07

## Object Metrics

- **Total objects created**: 570
- **Average objects per variable**: 1.26
- **Variables with no objects**: 0
- **Variables with singleton**: 484
- **Variables with multiple objects**: 89
...
- **Peak memory**: 32.76 MB
- **Current memory**: 29.49 MB
