...
**Generated:** 2025-10-26T11:39:09.579594
...
- **Total objects created**: 166
- **Average objects per variable**: 1.56
- **Variables with no objects**: 0
- **Variables with singleton**: 343
- **Variables with multiple objects**: 123
...
- **Peak memory**: 31.62 MB
- **Current memory**: 31.25 MB
