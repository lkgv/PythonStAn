...
**Generated:** 2025-10-26T01:32:57.439788
...
- **Variables with singleton**: 2419
- **Variables with multiple objects**: 2610
...
- **Current memory**: 41.02 MB

## Successfully Analyzed Modules

| Module | Duration (s) | Functions | LOC |
|--------|-------------|-----------|-----|
| __init__.py | 8.42 | 1 | 63 |
| __main__.py | 8.36 | 0 | 2 |
| app.py | 9.57 | 78 | 1857 |
| blueprints.py | 8.28 | 28 | 578 |
| cli.py | 8.88 | 31 | 760 |
| config.py | 8.03 | 12 | 262 |
| ctx.py | 9.01 | 26 | 324 |
| debughelpers.py | 7.62 | 6 | 129 |
| globals.py | 8.27 | 6 | 87 |
| helpers.py | 7.95 | 21 | 532 |