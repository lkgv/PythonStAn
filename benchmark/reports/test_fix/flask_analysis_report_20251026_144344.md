...
**Generated:** 2025-10-26T14:43:37.136527
...
- **Total objects created**: 302
- **Average objects per variable**: 1.74
- **Variables with no objects**: 0
- **Variables with singleton**: 1120
- **Variables with multiple objects**: 459
...
|--------|-------------|-----------|-----|
| __init__.py | 0.87 | 1 | 63 |
| __main__.py | 0.81 | 0 | 2 |
| app.py | 2.21 | 78 | 1857 |
| blueprints.py | 1.37 | 28 | 578 |
| cli.py | 1.83 | 31 | 760 |