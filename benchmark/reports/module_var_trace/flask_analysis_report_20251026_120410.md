...
**Generated:** 2025-10-26T12:04:08.806732
...
- **Current memory**: 31.28 MB

## Successfully Analyzed Modules

| Module | Duration (s) | Functions | LOC |
|--------|-------------|-----------|-----|
| __init__.py | 0.16 | 1 | 63 |
| __main__.py | 0.14 | 0 | 2 |
| app.py | 1.53 | 78 | 1857 |